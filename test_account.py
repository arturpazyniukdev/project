...
def expect_error(label, operation):
    try:
        operation()
...
savings = SavingsAccount('Savings', 100, Currency.USD, AccountStatus.ACTIVE, None, 10, 0.02)
savings2 = SavingsAccount('Savings2', 150, Currency.USD, AccountStatus.ACTIVE, None, 11, 0.05)
...
premium = PremiumAccount('Premium', 100, Currency.USD, AccountStatus.ACTIVE, None, None, 10, 1)
premium2 = PremiumAccount('Premium2', 100, Currency.USD, AccountStatus.ACTIVE, None, 23, 10, 1)
...
investment = InvestmentAccount('Investment', 130, Currency.USD, AccountStatus.ACTIVE, None)
investment2 = InvestmentAccount('Investment2', 120, Currency.USD, AccountStatus.ACTIVE, None)
